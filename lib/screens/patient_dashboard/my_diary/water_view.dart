...
import 'package:lith_app/screens/patient_dashboard/ui_view/wave_view.dart';
                    ...
                    if (snapshot.hasData) {
                      ...
                      for (var element in sn.docs) {
                        if (element.id == formattedDate) {
                          waterconsumed =
                              element.get("consumed(ml)").toDouble();
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: WaveView(
                                  percentageValue: (waterconsumed.toDouble() /
