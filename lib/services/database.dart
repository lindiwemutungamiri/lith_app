...
import '../screens/patient_dashboard/my_diary/my_diary_screen.dart';
...
class DatabaseService {
  ...
  Future<void> updatePatientUserData(
    String name,
    String username,
    String email,
    String phone,
  ...
  final CollectionReference foodTotalData = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
  ...
  final CollectionReference foodSetGoal = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
      .collection('food_track')
      .doc(formattedDate)
  ...
  final CollectionReference waterCollection = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
  ...
  final CollectionReference foodCollectionTotal = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
      .collection('food_track');
  ...
  final CollectionReference foodCollectionLunch = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
      .collection('food_track')
      .doc(formattedDate)
  ...
  final CollectionReference foodCollectionSnack = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
      .collection('food_track')
      .doc(formattedDate)
  ...
  final CollectionReference foodCollectionDinner = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
      .collection('food_track')
      .doc(formattedDate)
  ...
  final CollectionReference bodyCollection = FirebaseFirestore.instance
      .collection('userdata')
      .doc(user.uid)
      .collection('body_track');
  Future<void> updateBodyMesurmentData(
      int height,
      int weight,
      double bMR,
      double bMW,
  ...
  Future deleteuser() {
    return myCollection.doc(uid).delete();
  }
}
