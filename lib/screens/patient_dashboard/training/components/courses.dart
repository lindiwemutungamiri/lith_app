...
import 'package:lith_app/screens/patient_dashboard/training/data/data.dart';
import 'package:lith_app/screens/patient_dashboard/training/models/course.dart';
import 'package:lith_app/utils/constants.dart';
...
class Courses extends StatelessWidget {
  ...
  Widget _buildCourses(BuildContext context, int index) {
    ...
    Course course = getCourses(context)[index];
    ...
    return Column(
      children: [
        ...
        Padding(
            ...
            child: SizedBox(
                height: size.height * 0.22 * getCourses(context).length,
                child: ListView.builder(
                  physics: const NeverScrollableScrollPhysics(),
                  itemCount: getCourses(context).length,
