...
import 'package:lith_app/screens/patient_dashboard/fitness_app_theme.dart';
import 'package:lith_app/services/database.dart';
import 'package:lith_app/services/locator.dart';
import 'package:lith_app/services/user_controller.dart';
...
class _PatientProfileState extends State<PatientProfile> {
  ...
  void updatePatientUser() async {
    await DatabaseService(uid: activeDoctor.uid).updatePatientUserData(
      nameController.text,
